...
class Config:
    ...
    def __init__(self, config_file: pathlib.Path) -> None:
        ...
        self.team_devs: bool = self.register.init_option(
            section="Permissions",
            option="TeamDevs",
            dest="team_devs",
            default=ConfigDefaults.team_devs,
            getter="getboolean",
            comment=_Dd(
                "Load the app's team members as dev users automatically.\n"
                "Warning: dev-only commands can allow arbitrary remote code execution."
            ),
            editable=False,
        )
