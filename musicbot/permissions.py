...
class PermissionGroup:
    ...
    def __init__(
        ...
        self.ignore_non_voice = self._mgr.register.init_option(
            ...
            comment=_Dd(
                "List of command names that can only be used while in the same voice channel as DJ-Roomba.\n"
        ...
        self.extractors = self._mgr.register.init_option(
            ...
            comment=_Dd(
                ...
                "\n"
                "DJ-Roomba also provides one custom service `spotify:musicbot` to enable or disable Spotify API extraction.\n"
                "NOTICE: DJ-Roomba might not support all services available to yt-dlp!\n"
            ),
...
class PermissionOptionRegistry(ConfigOptionRegistry):
    ...
    def write_default_ini(self, filename: pathlib.Path) -> bool:
        ...
        try:
            ...
            head_comment = (
                "This is the permissions file for DJ-Roomba. Do not edit this file using Notepad.\n"
